...
<body>
	<h1>Extended Forecast for Leonia NJ</h1>
	...
	<?php
      ...
      $servername = "localhost";
		...
		foreach ($result as $row) {
			if ($row['set_homepage'] == 'leonia.php'){
				echo "<h2>";
   ...
   <form method="post" action="leonia.php">
...
<?php
	if($_SERVER['REQUEST_METHOD'] == "POST" and isset($_POST['cities']))
    {
		...
		$ip_insert = "INSERT INTO Personalization (ip, set_homepage) VALUES ('$ip', 'leonia.php')";
		$ip_update = "UPDATE Personalization SET set_homepage='leonia.php' WHERE ip='$ip'";
...
?>	
   ...
   <br>
	...
	$result = $mysqli->query("SELECT periods, temps, short_desc, long_desc FROM Leonia");
	foreach ($result as $row) {
		$long = $row['long_desc'];
