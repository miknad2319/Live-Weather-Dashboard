...
<body>
	<h1>Extended Forecast for Newark NJ</h1>
	<?php
      ...
      $servername = "localhost";
		...
		foreach ($result as $row) {
			if ($row['set_homepage'] == 'newark.php'){
				echo "<h2>";
    ...
    <form method="post" action="newark.php">
	...
	if($_SERVER['REQUEST_METHOD'] == "POST" and isset($_POST['cities']))
     {
      ...
      $servername = "localhost";
		...
		$ip_insert = "INSERT INTO Personalization (ip, set_homepage) VALUES ('$ip', 'newark.php')";
		$ip_update = "UPDATE Personalization SET set_homepage='newark.php' WHERE ip='$ip'";
...
?>	
   ...
   <br>
	...
	$result = $mysqli->query("SELECT periods, temps, short_desc, long_desc FROM Newark");
	foreach ($result as $row) {
		$long = $row['long_desc'];
